...
for i in range(len(dt_range)):
    ...
    while iteration < 1000:
        ...
        # else:
        # print(est_param)
    with open("/data/tests/jiaxing/scientific_research_with_python_demo/scientific_research_with_python_demo/data_save/dT_test2.csv", "a") as f:
        # 按列追加保存
...
np.savetxt("/data/tests/jiaxing/scientific_research_with_python_demo/scientific_research_with_python_demo/data_save/dTsuccess_test2.csv", success_rate)
T2 = time.perf_counter()
print("程序运行时间:%s秒" % (T2 - T1))
# dp.bar_plot(v_orig * 1000, success_rate, "Nifg=10,SNR=70db,dt=12", "snr_v_test5", 0.001 * 1000, "v[mm/year]")
dp.line_plot(12 * dt_range, success_rate, "n=10deg,v=0.01,nifg=30", "dT_test2", "dT[days]")
